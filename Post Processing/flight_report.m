...
%     xlim([start_time end_time])
    ...
    figure
    subplot(2,1,1)
    plot(exp.OSA_data.time, exp.OSA_data.Ax,...
        exp.OSA_data.time, exp.OSA_data.Ay,...
        exp.OSA_data.time, exp.OSA_data.Az)
    title('OSA IMU log acceleration time history')
    xlabel('time [sec]')
    ylabel('acceleration [mG]')
    legend('x','y','z')
%     xlim([start_time end_time])
    subplot(2,1,2)
    plot(exp.OSA_GUI.time + exp.OSA_GUI.start_time, exp.OSA_GUI.Ax,...
        exp.OSA_GUI.time + exp.OSA_GUI.start_time, exp.OSA_GUI.Ay,...
        exp.OSA_GUI.time + exp.OSA_GUI.start_time, exp.OSA_GUI.Az)
    title('OSA IMU GUI acceleration time history')
    xlabel('time [sec]')
    ylabel('acceleration [mG]')
    legend('x','y','z')
%     xlim([start_time end_time])
    ...
    figure
    subplot(2,1,1)
    plot(exp.IFA_data.time, exp.IFA_data.Gx,...
        exp.IFA_data.time, exp.IFA_data.Gy,...
        exp.IFA_data.time, exp.IFA_data.Gz)
    title('IFA IMU log angular velocity time history')
    xlabel('time [sec]')
    ylabel('angular velocity [dps]')
    legend('x','y','z')
    xlim([start_time end_time])
    subplot(2,1,2)
    plot(exp.IFA_GUI.time + exp.IFA_GUI.start_time, exp.IFA_GUI.Gx,...
        exp.IFA_GUI.time + exp.IFA_GUI.start_time, exp.IFA_GUI.Gy,...
        exp.IFA_GUI.time + exp.IFA_GUI.start_time, exp.IFA_GUI.Gz)
    title('IFA IMU GUI angular velocity time history')
    xlabel('time [sec]')
    ylabel('angular velocity [dps]')
    legend('x','y','z')
    xlim([start_time end_time])
    ...
    figure
    subplot(2,1,1)
    plot(exp.IFA_data.time, exp.IFA_data.Ax,...
        exp.IFA_data.time, exp.IFA_data.Ay,...
        exp.IFA_data.time, exp.IFA_data.Az)
    title('IFA IMU log acceleration time history')
    xlabel('time [sec]')
    ylabel('acceleration [mG]')
    legend('x','y','z')
    xlim([start_time end_time])
    subplot(2,1,2)
    plot(exp.IFA_GUI.time + exp.IFA_GUI.start_time, exp.IFA_GUI.Ax,...
        exp.IFA_GUI.time + exp.IFA_GUI.start_time, exp.IFA_GUI.Ay,...
        exp.IFA_GUI.time + exp.IFA_GUI.start_time, exp.IFA_GUI.Az)
    title('IFA IMU GUI acceleration time history')
    xlabel('time [sec]')
    ylabel('acceleration [mG]')
    legend('x','y','z')
    xlim([start_time end_time])
...
%     xlim([start_time end_time])
    ...
    figure
    subplot(2,1,1)
    plot(exp.OSA_data.time, exp.OSA_data.Ax*9.80665e-3,...
        exp.OSA_data.time, exp.OSA_data.Ay*9.80665e-3,...
        exp.OSA_data.time, exp.OSA_data.Az*9.80665e-3)
